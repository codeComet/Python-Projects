...
transactions_clean = []
transactions_clean = [[t.strip() for t in nested] for nested in daily_transactions_split]
...
for item in colors:
	sale = color_count(item)
	print("Thread Shed sold {} threads of {} thread today.".format(sale, item))
